  ...
  <div class="container container-off-padding">
    <div class="row row-off-margin">
      <div class="col-xs-12 col-sm-5 col-md-4 col-lg-4 right col-off-padding">
        ...
        <form class="txt-retorno valign-wrapper" method="post" role="form">
          <h4 class="center valign">O e-mail não pode ser enviado!<br/>
           <span>Tente novamente!<br/>
           Se o problema persistir,<br/> entre em contato pelo e-mail ...@.com.br</span></h4>
        </form> 
...
<div class="container-fluid container-off-padding" style="float: left">
  <figure>
